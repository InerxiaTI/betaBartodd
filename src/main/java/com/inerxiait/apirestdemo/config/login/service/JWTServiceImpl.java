package com.inerxiait.apirestdemo.config.login.service;
...
import com.inerxiait.apirestdemo.config.login.SimpleGrantedAuthorityMixin;
...
public class JWTServiceImpl implements JWTService {
	...
	String base64Key = Base64Utils.encodeToString(key.getEncoded());
